...
organization in ThisBuild := "com.stremlenye"

libraryDependencies in ThisBuild ++=
  Seq(
    compilerPlugin("org.spire-math" %% "kind-projector" % "0.9.7"),
    compilerPlugin("org.scalameta" % "paradise_2.12.4" % "3.0.0-M11")
  )

Compile / run / fork in ThisBuild := true
...
resolvers in ThisBuild ++= Seq(Resolver.sonatypeRepo("releases"))

watchSources in ThisBuild ++= (
